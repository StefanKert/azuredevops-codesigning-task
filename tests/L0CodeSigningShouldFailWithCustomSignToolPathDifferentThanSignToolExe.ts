...
const signToolPath: string = path.join(__dirname, "./test-files", "TestCertificate.pfx"); // We are using just a random file to check if it fails with a invalid file message
